            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="icone" id="icone" class="form-control">
                            ...
                            <option value="twf-cleaning-1" {{old('icone', isset($servico) && $servico->icone) === 'twf-cleposicaoaning-1' ? 'selected' : '' }}>ícone 1</option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ old('posicao', $servico->posicao ?? '') }}" type="input" data-mask="00" required class="form-control" name="posicao"  id="posicao"  placeholder="Posição do serviço na plataforma">
                    </div>
                </div>
            </div>
        </fieldset>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        data-mask="#.##0,00" data-mask-reverse="true" required class="form-control" name="valor_minimo" 
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        data-mask="0" required class="form-control" name="quantidade_horas" id="quantidade_horas" placeholder="Quantidade mínima de horas">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        data-mask="00" required class="form-control" name="porcentagem" id="porcentagem" placeholder="porcentagem de comissão no serviço">
                    </div>
                </div>
            </div>
        </fieldset>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="#.##0,00" data-mask-reverse="true" required class="form-control" name="valor_quarto" id="valor_quarto" placeholder="Valor por quarto">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="0" required class="form-control" name="horas_quarto" id="horas_quarto" placeholder="Quantidade horas por quarto">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="#.##0,00" data-mask-reverse="true" required class="form-control" name="valor_sala" id="valor_sala" placeholder="Valor por sala">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="0" required class="form-control" name="horas_sala" id="horas_sala" placeholder="Quantidade horas por sala">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="#.##0,00" data-mask-reverse="true" required class="form-control" name="valor_banheiro" id="valor_banheiro" placeholder="Valor por banheiro">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="0" required class="form-control" name="horas_banheiro" id="horas_banheiro" placeholder="Quantidade horas por banheiro">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="#.##0,00" data-mask-reverse="true" required class="form-control" name="valor_cozinha" id="valor_cozinha" placeholder="Valor por cozinha">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="0" required class="form-control" name="horas_cozinha" id="horas_cozinha" placeholder="Quantidade horas por cozinha">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="#.##0,00" data-mask-reverse="true" required class="form-control" name="valor_quintal" id="valor_quintal" placeholder="Valor por quintal">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="0" required class="form-control" name="horas_quintal" id="horas_quintal" placeholder="Quantidade horas por quintal">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="#.##0,00" data-mask-reverse="true" required class="form-control" name="valor_outros" id="valor_outros" placeholder="Valor por outros">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        data-mask="0" required class="form-control" name="horas_outros" id="horas_outros" placeholder="Quantidade horas por outros">
                    </div>
                </div>
            </div>
        </fieldset>
