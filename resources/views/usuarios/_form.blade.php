            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        required class="form-control" name="name" id="name" placeholder="Digite o nome do usuário">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        required class="form-control" name="email" id="email" placeholder="Digite o email do usuário">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        required class="form-control" name="password_confirmation" id="password_confirmation" placeholder="Confirme a senha do usuário">
                    </div>
                </div>
            </div>
        </fieldset>
